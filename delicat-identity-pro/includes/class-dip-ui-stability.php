...
final class DIP_UI_Stability {
    ...
    private static function checks() {
        ...
        $checks[] = ['HTTPS', DIP_Request::is_secure(), 'HTTPS est requis en production pour OAuth et les sessions.'];
    ...
    public static function page() {
        ...
        <div class="wrap dip-admin-wrap dip-ui-hub">
            ...
            <section class="dip-ui-overview">
                ...
                <article><span class="dashicons dashicons-lock"></span><div><small>Connexion sécurisée</small><strong><?php echo DIP_Request::is_secure() ? 'HTTPS actif' : 'Action requise'; ?></strong></div></article>
