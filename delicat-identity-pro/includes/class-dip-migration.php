...
final class DIP_Migration {
    ...
    public static function start_automatic($batch_size=25) {
        ...
        if (!DIP_Request::is_secure()) return new WP_Error('https_required','HTTPS est obligatoire avant la migration automatique.');
