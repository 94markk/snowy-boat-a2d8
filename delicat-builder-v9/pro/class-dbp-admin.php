...
final class DBP_Admin {
	...
	public static function render() {
		...
		echo '<tr><th scope="row">' . esc_html__( 'Client cache lifetime', 'delicat-builder-v9' ) . '</th><td>';
		echo '<input type="number" min="15" max="900" name="dbp[nav_cache_ttl]" value="' . esc_attr( (string) $settings['nav_cache_ttl'] ) . '"> ';
		echo esc_html__( 'seconds', 'delicat-builder-v9' );
		echo '<p class="description">' . esc_html__( 'How long a fetched page stays reusable in memory before it is fetched again.', 'delicat-builder-v9' ) . '</p>';
		echo '</td></tr>';
		...
		echo '<p class="description">' . esc_html__( 'Keep this low for shoppers on mobile data. Six is a sensible ceiling.', 'delicat-builder-v9' ) . '</p>';
		echo '</td></tr>';
