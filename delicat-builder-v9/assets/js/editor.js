(() => {
	...
	const renderInspector = () => {
		...
		if (section.type === 'hero') {
			...
			html += selectField('Heart icon', 'content.heart_icon', c.heart_icon || 'inherit', [['inherit','Inherit global'],['heart','Heart'],['heart_outline','Heart outline'],['star','Star'],['bolt','Bolt']]);
