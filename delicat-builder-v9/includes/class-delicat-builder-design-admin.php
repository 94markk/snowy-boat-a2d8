			...
			<form method="post" action="options.php">
				...
				<div class="delicat-admin__grid">
					<section class="delicat-admin__card">
						...
						<div class="delicat-field">
							<label><strong><?php esc_html_e( 'Heart icon', 'delicat-builder-v9' ); ?></strong></label>
							<select name="<?php echo esc_attr( Delicat_Builder_V9_Design::OPTION ); ?>[heart_icon]">
								<option value="heart" <?php selected( $s['heart_icon'] ?? 'heart', 'heart' ); ?>><?php esc_html_e( 'Heart', 'delicat-builder-v9' ); ?></option>
								<option value="heart_outline" <?php selected( $s['heart_icon'] ?? 'heart', 'heart_outline' ); ?>><?php esc_html_e( 'Heart outline', 'delicat-builder-v9' ); ?></option>
								<option value="star" <?php selected( $s['heart_icon'] ?? 'heart', 'star' ); ?>><?php esc_html_e( 'Star', 'delicat-builder-v9' ); ?></option>
								<option value="bolt" <?php selected( $s['heart_icon'] ?? 'heart', 'bolt' ); ?>><?php esc_html_e( 'Bolt', 'delicat-builder-v9' ); ?></option>
							</select>
						</div>
					...
					<section class="delicat-admin__card">
						...
						<label class="delicat-switch">
							...
							<span><strong><?php esc_html_e( 'Guest hearts on this device', 'delicat-builder-v9' ); ?></strong><small><?php esc_html_e( 'Guests use local browser storage only; no guest database write or unauthenticated AJAX endpoint.', 'delicat-builder-v9' ); ?></small></span>
						</label>
