<?php
/**
 * Print the checkout sheet's on-intent loader, exactly as the plugin prints it.
 *
 ...
 * approximation of.
 *
 * Usage: php scripts/emit-checkout-loader.php [base-url]
 */
...
require __DIR__ . '/../delicat-builder-v9/includes/class-delicat-builder-checkout-sheet.php';

echo Delicat_Builder_V9_Checkout_Sheet::loader_script();
