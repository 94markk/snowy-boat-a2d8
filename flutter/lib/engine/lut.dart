...
class LutBaker {
  ...
  /// Edge length of the cube. 64 is the size real grading LUTs ship at, and
  /// lays out exactly as 8x8 tiles of 64x64 in a 512x512 texture.
  static const int size = 64;
  static const int stripWidth = 512;
  ...
  /// The table as a 512x512 RGBA strip, ready to upload as a texture.
  static Uint8List bakeStrip(Adjustments a) {
    final pixels = Uint8List(stripWidth * stripWidth * 4);
  ...
  static Future<ui.Image> bakeImage(Adjustments a) {
  ...
  static String bakeCube(Adjustments a) {
